...
for episode in range(num_episodes):
    ...
    print(f"Episode: {episode+1}, Total Reward: {total_reward}, Epsilon: {epsilon}, Total Loss: {total_loss}, Time: {datetime.now().strftime('%H:%M:%S')}")
